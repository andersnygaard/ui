...
describe("when reporting warning", () => {
    ...
    context.results.error(action, message);
    ...
    it("should have a results with error severity on it", () => context.results.results[0].severity.should.equal(actionResultSeverity.error));
});