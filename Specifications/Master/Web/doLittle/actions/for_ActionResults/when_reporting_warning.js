...
describe("when reporting warning", () => {
    ...
    context.results.warning(action, message);
    ...
    it("should have a results with warning severity on it", () => context.results.results[0].severity.should.equal(actionResultSeverity.warning));
});