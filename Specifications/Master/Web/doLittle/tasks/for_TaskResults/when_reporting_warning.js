...
describe("when reporting warning", () => {
    ...
    context.results.warning(task, message);
    ...
    it("should have a results with warning severity on it", () => context.results.results[0].severity.should.equal(taskResultSeverity.warning));
});