...
describe("when reporting warning", () => {
    ...
    context.results.fatal(task, message);
    ...
    it("should have a results with fatal severity on it", () => context.results.results[0].severity.should.equal(taskResultSeverity.fatal));
});