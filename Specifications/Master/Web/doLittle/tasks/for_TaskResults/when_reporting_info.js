...
describe("when reporting info", () => {
    ...
    context.results.info(task, message);
    ...
    it("should have a results with info severity on it", () => context.results.results[0].severity.should.equal(taskResultSeverity.info));
});