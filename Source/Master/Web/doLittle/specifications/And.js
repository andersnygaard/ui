...
export class And extends Specification {
     ...
     * @param {Specification} leftHandSide The left hand side of the expression
     * @param {Specification} rightHandSide The right hand side of the expression
     */
     ...
     * @returns {Specification} instance for the left rule
     */
    get left() {
     ...
     * @returns {Specification} instance for the right rule
     */
    get right() {
